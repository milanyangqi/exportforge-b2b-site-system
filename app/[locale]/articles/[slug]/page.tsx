    ...
    <main className="subpage">
      ...
      <section className="section rfq-section" id="rfq">
        <div>
          ...
          <h2>Turn this article into a clear request.</h2>
          <p>Share product details, quantity, packaging, and destination so {state.siteSettings.title} can respond with a practical quotation.</p>
        </div>
