...
async function fetchSource(url: string) {
  ...
  const response = await fetch(parsedUrl.toString(), {
    headers: {
      "User-Agent": "GrillBeatsContentCollector/1.0"
    },
...
function buildPrompt(payload: CollectPayload, source: string) {
  ...
  return [
    "You are rewriting collected source material for the GrillBeats B2B bamboo skewers website.",
    "Return strict JSON only with this shape:",
    "{\"slug\":\"...\",\"title\":{\"en\":\"...\",\"zh\":\"...\"},\"excerpt\":{\"en\":\"...\",\"zh\":\"...\"},\"body\":{\"en\":\"markdown...\",\"zh\":\"markdown...\"}}",
    `Create a ${target} draft. Do not copy the source directly. Rewrite it into original, buyer-focused B2B content for bamboo skewers, foodservice buyers, retail packaging, or wholesale sourcing.`,
