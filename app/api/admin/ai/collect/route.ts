...
async function fetchSource(url: string) {
  ...
  const response = await fetch(parsedUrl.toString(), {
    headers: {
      "User-Agent": "Xiyida PackagingContentCollector/1.0"
    },
...
function buildPrompt(payload: CollectPayload, source: string) {
  ...
  return [
    "You are rewriting collected source material for the Xiyida Packaging B2B custom tin packaging website.",
    "Return strict JSON only with this shape:",
    "{\"slug\":\"...\",\"title\":{\"en\":\"...\",\"zh\":\"...\"},\"excerpt\":{\"en\":\"...\",\"zh\":\"...\"},\"body\":{\"en\":\"markdown...\",\"zh\":\"markdown...\"}}",
    `Create a ${target} draft. Do not copy the source directly. Rewrite it into original, buyer-focused B2B content for custom tin boxes, food tins, gift tins, cosmetic tins, printing finishes, export packing, or packaging buyers.`,
