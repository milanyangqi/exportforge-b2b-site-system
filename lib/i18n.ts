...
export const ui = {
  ...
  heroKicker: { en: "Custom 3D printing for global buyers", zh: "面向海外客户的定制 3D 打印", vi: "Dụng cụ cắt CNC cho khách hàng toàn cầu", th: "เครื่องมือตัด CNC สำหรับผู้ซื้อทั่วโลก", id: "Alat potong CNC untuk pembeli global", ar: "أدوات قطع CNC للمشترين العالميين" },
  heroTitle: { en: "Your CAD file. A real part. A clearer path forward.", zh: "从图纸出发，定制您需要的零件。", vi: "Dao phay carbide và mũi khoan cho chương trình phân phối.", th: "ดอกเอ็นมิลคาร์ไบด์และดอกสว่านสำหรับผู้จัดจำหน่าย", id: "End mill carbide dan mata bor untuk distributor.", ar: "قواطع كربيد ولقم ثقب جاهزة للموزعين." },
  heroBody: { en: "Send your CAD drawing and part requirements for review and quotation.", zh: "提交 CAD 图纸与零件要求，以便评估和报价。", ar: "توفر CuriousMake قواطع التفريز ولقم الثقب والأدوات المخصصة والتغليف الخاص ودعم الفحص للتصدير." }
