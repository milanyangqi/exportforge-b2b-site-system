...
function dataWithFooterDraftProps(data: VisualPageLayoutData | undefined, state: AdminState, locale: LocaleCode): VisualPageLayoutData {
  ...
  return {
    ...
    root: {
      ...
      props: {
        ...rootProps,
        footerTagline: localizedTemplateText(state.templateSettings.footerTagline, locale, "Custom 3D printing inquiries for overseas buyers."),
        ...
        footerCredit: localizedTemplateText(state.templateSettings.footerCredit, locale, "From drawing to discussion.")
    ...
    imageItems: [
      {
        ...
        url: "",
        alt: "Illustrative CuriousMake part image",
        caption: "",
        linkHref: ""
      }
    ],
    ...
    components: {
      ...
      HeroSection: {
        ...
        defaultProps: {
          ...
          title: "Custom 3D printing from your CAD file.",
