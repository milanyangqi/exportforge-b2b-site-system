...
function dataWithFooterDraftProps(data: VisualPageLayoutData | undefined, state: AdminState, locale: LocaleCode): VisualPageLayoutData {
  ...
  return {
    ...
    root: {
      ...
      props: {
        ...rootProps,
        footerTagline: localizedTemplateText(state.templateSettings.footerTagline, locale, "Bamboo skewers and packaging options for wholesale buyers."),
        ...
        footerCredit: localizedTemplateText(state.templateSettings.footerCredit, locale, "Bamboo skewers for your business.")
...
function customSectionDefaultProps(moduleType: CustomSectionModuleType = "media") {
  ...
  return {
    ...
    mediaLibraryUrl: "/assets/current-template/hero.webp",
    mediaUrl: "/assets/current-template/hero.webp",
    imageMode: moduleType === "text" || moduleType === "cta" ? "none" : "single",
    imageItems: [
      {
        source: "/assets/current-template/hero.webp",
        url: "",
        alt: "GrillBeats bamboo skewer image",
        caption: "",
        linkHref: ""
      }
    ],
  ...
  return {
    ...
    components: {
      ...
      HeroSection: {
        ...
        defaultProps: {
          eyebrow: "Wholesale bamboo skewers",
          title: "Bamboo skewers and packaging for your business.",
