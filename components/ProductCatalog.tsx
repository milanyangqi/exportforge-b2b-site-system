...
const types: Record<string, { en: string; zh: string }> = {"makeup-brush":{en:"Makeup brushes",zh:"化妆刷"},"sponge-puff":{en:"Sponges & puffs",zh:"美妆蛋与粉扑"},"lash-tool":{en:"Lash tools",zh:"睫毛工具"},"gift-set":{en:"Gift sets",zh:"礼盒套装"}};
