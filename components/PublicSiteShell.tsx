...
export function PublicFooterShell({
  ...
  const handleLinkClick: LinkClickHandler | undefined = preventNavigation
    ? (event) => event.preventDefault()
    : undefined;
  const footerTagline = tagline ? t(tagline, locale) : "Handcrafted textiles inspired by gardens and everyday home.";
  ...
  const footerCredit = credit ? t(credit, locale) : "Made with a love of texture.";
