...
const contactTypePresets: Record<ContactChannelType, { en: string; zh: string; value: string; href: string; color: string }> = {
  ...
  wechat: { en: "WeChat", zh: "微信", value: "", href: "", color: "#23c80d" },
  ...
  rfq: { en: "RFQ", zh: "询盘", value: "", href: "", color: "#243b78" },
...
export function AdminApp({ email, initialTab, locale }: { email: string; initialTab?: string; locale: LocaleCode }) {
  ...
  function buildLeadReplyDraft(lead: AdminState["leads"][number]) {
    ...
    const body = template
      ...
      .replaceAll("{productType}", lead.productType || "your textile inquiry")
      .replaceAll("{quantity}", lead.quantity || "")
      .replaceAll("{email}", lead.email || "")
      .replaceAll("{siteTitle}", state?.siteSettings.title || "Rivermake");
  ...
  if (!state) {
    return (
      <main className="real-admin">
        <div className="admin-topbar"><strong>Rivermake Admin</strong><span>{status}</span></div>
      </main>
    );
  }
	            ...
	            <div className="visual-front-navigation-inner">
	              <div className="visual-front-brand">
	                ...
	                {renderVisualTextTarget({
	                  ...
	                  value: state.siteSettings.title || "Rivermake",
	                  element: "strong",
          ...
          <div className="visual-rfq-panel">
            <div>
              ...
              {renderVisualTextTarget({
                ...
                value: visualText("rfqTitle", "把您的编织作品需求发给 Rivermake"),
                element: "h3",
                multiline: true,
                  ...
                  <div className="mail-account-section">
                    ...
                    {!collapsedMailSections.content ? <div className="mail-content-grid">
                      ...
                      <div className="mail-template-preview">
                        <strong>预览</strong>
                        <pre>{(state.siteSettings.mailReplyTemplate || "").replaceAll("{name}", "Alex").replaceAll("{company}", "Example Studio").replaceAll("{productType}", "crochet textiles").replaceAll("{quantity}", "500 pcs").replaceAll("{email}", "buyer@example.com").replaceAll("{siteTitle}", state.siteSettings.title || "Rivermake")}</pre>
                      </div>
              ...
              <div className="account-settings-grid">
                ...
                <section className="account-security-card">
                  ...
                  <div className="account-info-list">
                    <div><span>后台名称</span><strong>Rivermake Admin</strong></div>
                    ...
                    {aiWizardStep === 3 ? (
                      <>
                        <div className="ai-guided-form">
                          <label>内容主题
                            <input
                              placeholder={aiContentForm.target === "article" ? "例如：钩织家居系列" : "例如：手工织物系列"}
